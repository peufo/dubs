...
export interface Action {
  ...
  sections?:
    | {
        ...
        layout?: ('row' | 'row_reverse' | 'col' | 'col_reverse') | null;
        id?: string | null;
      }[]
    | null;
  inputs?:
  ...
  outputs?:
    ...
    | null;
  timeUnit?: ('millisecond' | 'second' | 'minute' | 'hour' | 'day' | 'week' | 'month' | 'year') | null;
  estimatedDuration?: number | null;
  remoteUpdate?: boolean | null;
  updatedAt: string;
  createdAt: string;
}
/**
